...
%% @reference https://github.com/leo-project/leo_konsul/blob/master/src/leo_mdcr_tbl_sync.erl
%% @end
%%======================================================================
...
sync_tables_1([#redundant_node{node = Node,
                               available = true}|Rest]) ->
    %% @TODO - leo_konsul_api:get_cluster_tbl_checksums/1
    case rpc:call(Node, leo_konsul_api,
                  get_cluster_tbl_checksums, [{}]) of
        {ok, ResL_1} ->
            %% TODO - leo_konsul_api:get_cluster_tbl_checksums/1
            {ok, ResL_2} = leo_konsul_api:get_cluster_tbl_checksums({}),
